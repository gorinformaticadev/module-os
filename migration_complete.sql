-- ═══════════════════════════════════════════════════════════════════════════
-- MIGRATION COMPLETA: Módulo Ordem de Serviço - Todas as Tabelas
-- Versão: 2.2.0 - Migração consolidada para instalação
-- Data: 2026-01-24
-- Descrição: Migration completa com todas as tabelas e dados do módulo
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 10. CRIAÇÃO DE TODOS OS ÍNDICES
-- ═══════════════════════════════════════════════════════════════════════════
