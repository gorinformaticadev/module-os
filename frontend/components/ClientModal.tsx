                ...
                <div className="py-4 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="md:col-span-2 space-y-2">
                            <Label htmlFor="client-name" className="text-xs font-bold uppercase tracking-wider text-slate-500">Nome Completo *</Label>
                            <Input
                                id="client-name"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="client-document" className="text-xs font-bold uppercase tracking-wider text-slate-500">CPF / CNPJ</Label>
                            <Input
                                id="client-document"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="client-phone1" className="text-xs font-bold uppercase tracking-wider text-slate-500">Telefone Principal *</Label>
                            <Input
                                id="client-phone1"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="client-phone2" className="text-xs font-bold uppercase tracking-wider text-slate-500">Telefone Secundário</Label>
                            <Input
                                id="client-phone2"
                                className="h-11 bg-slate-50/50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-800"
                        ...
                        {showAddress && (
                            <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4 animate-in fade-in slide-in-from-top-2 duration-300">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="client-street" className="text-xs font-bold uppercase tracking-wider text-slate-500">Rua</Label>
                                    <Input
                                        id="client-street"
                                        className="h-11 bg-slate-50/50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-800"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="client-number" className="text-xs font-bold uppercase tracking-wider text-slate-500">Número</Label>
                                    <Input
                                        id="client-number"
                                        className="h-11 bg-slate-50/50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-800"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="client-complement" className="text-xs font-bold uppercase tracking-wider text-slate-500">Complemento</Label>
                                    <Input
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="client-neighborhood" className="text-xs font-bold uppercase tracking-wider text-slate-500">Bairro</Label>
                                    <Input
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="client-city" className="text-xs font-bold uppercase tracking-wider text-slate-500">Cidade</Label>
                                    <Input
                                        id="client-city"
                                        className="h-11 bg-slate-50/50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-800"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="client-state" className="text-xs font-bold uppercase tracking-wider text-slate-500">UF</Label>
                                    <Input
                                        id="client-state"
                                        className="h-11 bg-slate-50/50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-800"
