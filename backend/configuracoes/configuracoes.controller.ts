...
export class ConfiguracoesController {
  ...
  async getUsers(@Req() req: ExpressRequest & { user: any }) {
    try {
      this.logger.log(
        `getUsers endpoint chamado. Tenant: ${req.user?.tenantId}`,
      );
  ...
  async toggleTechnician(
    ...
    try {
      this.logger.log(
        `toggleTechnician endpoint chamado. User: ${id}, isTechnician: ${body.is_technician}`,
      );
      return await this.service.toggleTechnician(id, body.is_technician);
    } catch (error) {
  ...
  async getProfilePermissions(@Req() req: ExpressRequest & { user: any }) {
    try {
      this.logger.log(
        `getProfilePermissions endpoint chamado. Tenant: ${req.user?.tenantId}`,
      );
      return await this.service.getProfilePermissions();
    } catch (error) {
  ...
  async updateProfilePermissions(
    ...
    try {
      this.logger.log(
        `updateProfilePermissions endpoint chamado. Tenant: ${req.user?.tenantId}`,
      );
      return await this.service.updateProfilePermissions(body.permissions);
    } catch (error) {
  ...
  async getNotifications(@Req() req: ExpressRequest & { user: any }) {
    try {
      this.logger.log(
        `getNotifications endpoint chamado. Tenant: ${req.user?.tenantId}`,
      );
  ...
  async createNotification(
    ...
    try {
      this.logger.log(
        `createNotification endpoint chamado. Tenant: ${req.user?.tenantId}`,
      );
      return await this.service.createNotification(body);
    } catch (error) {
  ...
  async getAiConfig(@Req() req: ExpressRequest & { user: any }) {
    try {
      this.logger.log(
        `getAiConfig endpoint chamado. Tenant: ${req.user?.tenantId}`,
      );
      return await this.service.getAiConfig();
    } catch (error) {
  ...
  async updateAiConfig(
    ...
    try {
      this.logger.log(
        `updateAiConfig endpoint chamado. Tenant: ${req.user?.tenantId}`,
      );
      return await this.service.updateAiConfig(body);
    } catch (error) {
  ...
  async testAiConfig(
    ...
    try {
      this.logger.log(
        `testAiConfig endpoint chamado. Tenant: ${req.user?.tenantId}`,
      );
      return await this.service.testAiConfig(body);
    } catch (error) {
  ...
  async getConfigurations(@Req() req: ExpressRequest & { user: any }) {
    try {
      this.logger.log(
        `getConfigurations endpoint chamado. Tenant: ${req.user?.tenantId}`,
      );
  ...
  async saveConfiguration(
    @Req() req: ExpressRequest & { user: any },
    @Body() body: { config_key: string; config_value: any },
  ) {
    try {
      this.logger.log(
        `saveConfiguration endpoint chamado. Tenant: ${req.user?.tenantId}, Key: ${body.config_key}`,
      );
