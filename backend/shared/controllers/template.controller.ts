...
export class TemplateController {
    ...
    @Get(':id')
    @RequireConfigPermission('view')
    async findById(@Req() req: ExpressRequest & { user: any }, @Param('id') id: string) {
        try {
    ...
    @Put(':id')
    @RequireConfigPermission('manage_permissions')
    async update(@Req() req: ExpressRequest & { user: any }, @Param('id') id: string, @Body() data: any) {
        try {
    ...
    @Delete(':id')
    @RequireConfigPermission('manage_permissions')
    async delete(@Req() req: ExpressRequest & { user: any }, @Param('id') id: string) {
        try {
